...
awful.keyboard.append_global_keybindings({
  awful.key({ modkey }, "Up", function()
    awful.util.spawn_with_shell("~/.local/bin/volume_changer up")
  end, { description = "increase volume", group = "audio" }),
  awful.key({ modkey }, "Down", function()
    awful.util.spawn_with_shell("~/.local/bin/volume_changer down")
  end, { description = "decrease volume", group = "audio" }),
  awful.key({ modkey }, "Left", function()
    awful.util.spawn_with_shell("~/.local/bin/brightness_changer down")
  end, { description = "decrease brightness", group = "tag" }),
  awful.key({ modkey }, "Right", function()
    awful.util.spawn_with_shell("~/.local/bin/brightness_changer up")
  end, { description = "increase brightness", group = "tag" }),
